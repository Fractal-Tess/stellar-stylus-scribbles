    ...
    <footer className="bg-cosmic-void-black py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-white/70 mb-4">
              Exploring the mysteries of the universe through cutting-edge
              cosmology research and discoveries.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-white/60 hover:text-cosmic-stellar-cyan transition-colors"
              >
        ...
        <div className="border-t border-white/10 mt-12 pt-6 text-center text-white/60">
          <p>
            &copy; {new Date().getFullYear()} CosmicInsights. All rights
            reserved.
          </p>
        </div>
      </div>
